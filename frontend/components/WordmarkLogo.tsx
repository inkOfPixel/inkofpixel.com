...
export const WordmarkLogoLink = chakra(
  (props: PropsWithChildren<WordmarkLogoLink>) => {
    return (
      <Link href={props.url} passHref>
        <Box as="a">{props.children}</Box>
      </Link>
    );
  }
);

export const WordmarkLogo = chakra(
  ({ width, height, color = "rgb(19,22,57)", ...otherProps }: IconProps) => {
    color = color.toString(); //Color is of type Token<CSS.Property.Color, "colors">, so i have to transform it as a string
    return (
      <Icon width={width} height={height} viewBox="0 0 554 150" {...otherProps}>
        <path
          fill={color}
        ...
        <path
          fill={color}
          d="M186.77,38.2V30.7h5.89v7.5Zm0,62.5v-50h5.89v50Z"
        />
        <path
          fill={color}
        ...
        <path
          fill={color}
          d="M436.65,38.2V30.7h5.89v7.5Zm0,62.5v-50h5.89v50Z"
        />
        <path
          fill={color}
