...
export type GetGlobalQuery = (
  ...
  & { global?: Maybe<(
    ...
    & { topbar?: Maybe<(
      ...
      { __typename?: 'ComponentGlobalFooter' }
      & Pick<ComponentGlobalFooter, 'id' | 'description'>
    )> }
  )> }
);
